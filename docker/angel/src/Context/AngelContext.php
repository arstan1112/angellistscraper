...
class AngelContext implements Context
{
    ...
    private function startExecution()
    {
        ...
        $this->angelLogger->info('HEADERS SET');

        $this->checkConnection(function(){
            $noConnection = true;
        }, self::RECONNECTION_ATTEMPT_MILLISECONDS);

        $this->angelLogger->info('CONNECTION CHECKED');
    ...
    protected function loopTypes()
    {
        ...
        $types = ['Private Company', 'Incubator'];
    ...
    {
        $this->loopPages();
        $this->angelLogger->info('[Line ' . __LINE__ . '] FIRST LOOP SUCCEED');
